...
#| results: 'hide'
#| code-fold: true
#| code-summary: "Click to see the python script"
...
```{r}
#| code-fold: true
#| code-summary: "Click to see source code"
...
kable(emotional_tibble,col.names = c("Album", "Total Lines", "Emotional Lines", "Proportion"),  caption = "Table 1: Table of emotional lines in SOUR vs GUTS")
```
...
kable(person_tibble, caption = "Table 2: Table of Point of View Proportion")
```
